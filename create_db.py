...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith', 'major_id':3, 'email': 'robert12@umd.edu',
            'birth_date': dt.date(2007, 6, 1), 'is_honors':1},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'major_id':6, 'email': 'vanmunching@umd.edu',
